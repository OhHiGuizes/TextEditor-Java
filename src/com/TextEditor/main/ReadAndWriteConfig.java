...
public class ReadAndWriteConfig {
    static File configFile = new File("src/com/TextEditor/.config/recent-file.conf");
    ...
    public static File readConfig() {
        ...
        if (recentFiles.getProperty("file") == null) {
            openedFile = new File("/home/corey/git/TextEditor-Java/src/com/TextEditor/test_files/text.txt");
